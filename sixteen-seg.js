...
function Seg16(id) {
	...
	this.CODE_SEG_TABLE = [];
	this.CODE_SEG_TABLE[ 32] = 0x00000; // ' '(0x20)
	this.CODE_SEG_TABLE[ 33] = 0x13000; // '!'(0x21)
	this.CODE_SEG_TABLE[ 34] = 0x02040; // '"'(0x22)
	this.CODE_SEG_TABLE[ 35] = 0x00f55; // '#'(0x23)
	this.CODE_SEG_TABLE[ 36] = 0x0dd55; // '$'(0x24)
	this.CODE_SEG_TABLE[ 37] = 0x09977; // '%'(0x25)
	this.CODE_SEG_TABLE[ 38] = 0x09ec9; // '&'(0x26)
	this.CODE_SEG_TABLE[ 39] = 0x00040; // '''(0x27)
	this.CODE_SEG_TABLE[ 40] = 0x00028; // '('(0x28)
	this.CODE_SEG_TABLE[ 41] = 0x00082; // ')'(0x29)
	this.CODE_SEG_TABLE[ 42] = 0x000ff; // '*'(0x2a)
	this.CODE_SEG_TABLE[ 43] = 0x00055; // '+'(0x2b)
	this.CODE_SEG_TABLE[ 44] = 0x00002; // ','(0x2c)
	this.CODE_SEG_TABLE[ 45] = 0x00011; // '-'(0x2d)
	this.CODE_SEG_TABLE[ 46] = 0x10000; // '.'(0x2e)
	this.CODE_SEG_TABLE[ 47] = 0x00022; // '/'(0x2f)
	this.CODE_SEG_TABLE[ 48] = 0x0ff22; // '0'(0x30)
	this.CODE_SEG_TABLE[ 49] = 0x03020; // '1'(0x31)
	this.CODE_SEG_TABLE[ 50] = 0x0ee11; // '2'(0x32)
	this.CODE_SEG_TABLE[ 51] = 0x0fc11; // '3'(0x33)
	this.CODE_SEG_TABLE[ 52] = 0x03111; // '4'(0x34)
	this.CODE_SEG_TABLE[ 53] = 0x0dd11; // '5'(0x35)
	this.CODE_SEG_TABLE[ 54] = 0x0df11; // '6'(0x36)
	this.CODE_SEG_TABLE[ 55] = 0x0f100; // '7'(0x37)
	this.CODE_SEG_TABLE[ 56] = 0x0ff11; // '8'(0x38)
	this.CODE_SEG_TABLE[ 57] = 0x0fd11; // '9'(0x39)
	this.CODE_SEG_TABLE[ 58] = 0x00044; // ':'(0x3a)
	this.CODE_SEG_TABLE[ 59] = 0x00042; // ';'(0x3b)
	this.CODE_SEG_TABLE[ 60] = 0x00029; // '<'(0x3c)
	this.CODE_SEG_TABLE[ 61] = 0x00c11; // '='(0x3d)
	this.CODE_SEG_TABLE[ 62] = 0x00092; // '>'(0x3e)
	this.CODE_SEG_TABLE[ 63] = 0x1e014; // '?'(0x3f)
	this.CODE_SEG_TABLE[ 64] = 0x0ef30; // '@'(0x40)
	this.CODE_SEG_TABLE[ 65] = 0x0f311; // 'A'(0x41)
	this.CODE_SEG_TABLE[ 66] = 0x0fc54; // 'B'(0x42)
	this.CODE_SEG_TABLE[ 67] = 0x0cf00; // 'C'(0x43)
	this.CODE_SEG_TABLE[ 68] = 0x0fc44; // 'D'(0x44)
	this.CODE_SEG_TABLE[ 69] = 0x0cf11; // 'E'(0x45)
	this.CODE_SEG_TABLE[ 70] = 0x0c311; // 'F'(0x46)
	this.CODE_SEG_TABLE[ 71] = 0x0df10; // 'G'(0x47)
	this.CODE_SEG_TABLE[ 72] = 0x03311; // 'H'(0x48)
	this.CODE_SEG_TABLE[ 73] = 0x0cc44; // 'I'(0x49)
	this.CODE_SEG_TABLE[ 74] = 0x03e00; // 'J'(0x4a)
	this.CODE_SEG_TABLE[ 75] = 0x00329; // 'K'(0x4b)
	this.CODE_SEG_TABLE[ 76] = 0x00f00; // 'L'(0x4c)
	this.CODE_SEG_TABLE[ 77] = 0x033a4; // 'M'(0x4d)
	this.CODE_SEG_TABLE[ 78] = 0x03388; // 'N'(0x4e)
	this.CODE_SEG_TABLE[ 79] = 0x0ff00; // 'O'(0x4f)
	this.CODE_SEG_TABLE[ 80] = 0x0e311; // 'P'(0x50)
	this.CODE_SEG_TABLE[ 81] = 0x0ff08; // 'Q'(0x51)
	this.CODE_SEG_TABLE[ 82] = 0x0e319; // 'R'(0x52)
	this.CODE_SEG_TABLE[ 83] = 0x0dd11; // 'S'(0x53)
	this.CODE_SEG_TABLE[ 84] = 0x0c044; // 'T'(0x54)
	this.CODE_SEG_TABLE[ 85] = 0x03f00; // 'U'(0x55)
	this.CODE_SEG_TABLE[ 86] = 0x00322; // 'V'(0x56)
	this.CODE_SEG_TABLE[ 87] = 0x0334a; // 'W'(0x57)
	this.CODE_SEG_TABLE[ 88] = 0x000aa; // 'X'(0x58)
	this.CODE_SEG_TABLE[ 89] = 0x02115; // 'Y'(0x59)
	this.CODE_SEG_TABLE[ 90] = 0x0cc22; // 'Z'(0x5a)
	this.CODE_SEG_TABLE[ 91] = 0x04844; // '['(0x5b)
	this.CODE_SEG_TABLE[ 92] = 0x00088; // '\'(0x5c)
	this.CODE_SEG_TABLE[ 93] = 0x08444; // ']'(0x5d)
	this.CODE_SEG_TABLE[ 94] = 0x0000a; // '^'(0x5e)
	this.CODE_SEG_TABLE[ 95] = 0x00c00; // '_'(0x5f)
	this.CODE_SEG_TABLE[ 96] = 0x00080; // '`'(0x60)
	this.CODE_SEG_TABLE[ 97] = 0x0060d; // 'a'(0x61)
	this.CODE_SEG_TABLE[ 98] = 0x00705; // 'b'(0x62)
	this.CODE_SEG_TABLE[ 99] = 0x00601; // 'c'(0x63)
	this.CODE_SEG_TABLE[100] = 0x00645; // 'd'(0x64)
	this.CODE_SEG_TABLE[101] = 0x00603; // 'e'(0x65)
	this.CODE_SEG_TABLE[102] = 0x04055; // 'f'(0x66)
	this.CODE_SEG_TABLE[103] = 0x08545; // 'g'(0x67)
	this.CODE_SEG_TABLE[104] = 0x00305; // 'h'(0x68)
	this.CODE_SEG_TABLE[105] = 0x00004; // 'i'(0x69)
	this.CODE_SEG_TABLE[106] = 0x00644; // 'j'(0x6a)
	this.CODE_SEG_TABLE[107] = 0x0006c; // 'k'(0x6b)
	this.CODE_SEG_TABLE[108] = 0x00044; // 'l'(0x6c)
	this.CODE_SEG_TABLE[109] = 0x01215; // 'm'(0x6d)
	this.CODE_SEG_TABLE[110] = 0x00205; // 'n'(0x6e)
	this.CODE_SEG_TABLE[111] = 0x00605; // 'o'(0x6f)
	this.CODE_SEG_TABLE[112] = 0x08341; // 'p'(0x70)
	this.CODE_SEG_TABLE[113] = 0x08145; // 'q'(0x71)
	this.CODE_SEG_TABLE[114] = 0x00201; // 'r'(0x72)
	this.CODE_SEG_TABLE[115] = 0x08505; // 's'(0x73)
	this.CODE_SEG_TABLE[116] = 0x00015; // 't'(0x74)
	this.CODE_SEG_TABLE[117] = 0x00604; // 'u'(0x75)
	this.CODE_SEG_TABLE[118] = 0x00202; // 'v'(0x76)
	this.CODE_SEG_TABLE[119] = 0x0120a; // 'w'(0x77)
	this.CODE_SEG_TABLE[120] = 0x000aa; // 'x'(0x78)
	this.CODE_SEG_TABLE[121] = 0x000a4; // 'y'(0x79)
	this.CODE_SEG_TABLE[122] = 0x00403; // 'z'(0x7a)
	this.CODE_SEG_TABLE[123] = 0x04845; // '{'(0x7b)
	this.CODE_SEG_TABLE[124] = 0x00044; // '|'(0x7c)
	this.CODE_SEG_TABLE[125] = 0x08454; // '}'(0x7d)
	this.CODE_SEG_TABLE[126] = 0x0a150; // '~'(0x7e)
};
